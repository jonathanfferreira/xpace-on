    ...
    const steps: Step[] = [
        {
            ...
            content: (
                <div className="text-left font-sans">
                    ...
                    <p className="text-sm text-[#ddd]">Esta é a Central de Inteligência de Dança da XPACE ON. Vamos fazer um tour de 30 segundos pela sua nova nave para que você não perca tempo.</p>
                </div>
            ),
            disableBeacon: true,
        },
