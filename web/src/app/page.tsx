            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              >
                <span className="relative z-10 flex items-center gap-2">
                  Garantir Minha Vaga <Image src="/images/xpace-seta.png" alt="Seta para Direita" width={18} height={18} className="object-contain" />
                </span>
                ...
                <span className="absolute inset-0 text-white z-20 flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200 font-bold uppercase tracking-[0.2em] text-sm">
                  Garantir Minha Vaga <Image src="/images/xpace-seta.png" alt="Seta" width={18} height={18} className="object-contain invert brightness-0" />
                </span>
              </Link>
