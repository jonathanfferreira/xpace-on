    ...
    <div className="min-h-screen bg-black text-[#ededed] font-sans overflow-x-hidden selection:bg-primary/30 selection:text-white">
      ...
      <main className="relative z-10 pt-32 pb-20 md:pt-48 md:pb-32 px-6">
        <div className="max-w-7xl mx-auto flex flex-col items-center text-center">
          ...
          <h1 className="font-display text-5xl md:text-8xl leading-[1.1] md:leading-[1.0] font-bold text-white mb-6 tracking-tight">
          ...
          <p className="max-w-2xl mx-auto text-lg md:text-xl text-[#888] mb-12 font-light tracking-wide">
        ...
        <div id="preview" className="max-w-6xl mx-auto mt-24 relative perspective-[2000px]">
      ...
      <section className="relative z-10 py-32 bg-black">
        <div className="max-w-7xl mx-auto px-6 flex flex-col items-center">
          ...
          <h2 className="font-display text-4xl md:text-5xl font-bold text-white mb-16 text-center uppercase tracking-tight">O palco é <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#6324b2] to-[#eb00bc]">Todo Seu</span></h2>

          <div className="w-full max-w-md bg-gradient-to-b from-[#111] to-[#050505] p-[1px] rounded-xl relative group">
            {/* Glow ring on hover */}
...
function FeatureCard({ icon, title, desc }: { icon: React.ReactNode, title: string, desc: string }) {
  return (
    <div className="bg-[#050505] border border-[#1a1a1a] p-8 rounded-xl hover:bg-[#0a0a0a] hover:border-[#333] transition-all duration-300 group">
