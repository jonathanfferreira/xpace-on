            ...
            <main className="max-w-3xl mx-auto pt-40 pb-20 px-6">
                ...
                <div className="space-y-12 font-sans text-[#ccc] leading-relaxed">
                    <section>
                        ...
                        <p className="mb-4">
                            Ao acessar e utilizar a plataforma XPACE ON, você concorda em cumprir estes termos de serviço
                    ...
                    <section>
                        ...
                        <ul className="list-disc pl-5 space-y-3">
                            ...
                            <li>Tentar descompilar ou fazer engenharia reversa de qualquer software contido no site XPACE ON;</li>
