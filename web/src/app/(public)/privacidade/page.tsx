            ...
            <main className="max-w-3xl mx-auto pt-40 pb-20 px-6">
                ...
                <div className="space-y-12 font-sans text-[#ccc] leading-relaxed">
                    <section>
                        ...
                        <p className="mb-4">
                            Em nossa plataforma XPACE ON, coletamos apenas os dados essenciais para o funcionamento
                    ...
                    <section>
                        ...
                        <p className="mb-4">
                            ...
                            O XPACE ON não armazena números de cartão de crédito brutos em nosso banco de dados.
                        </p>
                    </section>
