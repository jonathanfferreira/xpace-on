            ...
            <div className="z-10 w-full max-w-md relative group mt-8">
                ...
                <div className="relative bg-[#0d0d0d]/80 border border-surface rounded-2xl p-8 backdrop-blur-2xl">
                    ...
                    <form className="space-y-6">
                        ...
                        <button
                            type="button"
                            className="w-full relative overflow-hidden rounded-lg bg-white text-black font-sans font-bold py-3.5 transition-transform duration-200 active:scale-[0.98] mt-4"
                        >
